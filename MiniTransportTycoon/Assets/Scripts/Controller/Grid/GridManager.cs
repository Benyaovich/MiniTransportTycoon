...
namespace Controller.Grid
{
    public class GridManager : MonoBehaviour
    {
        ...
        private GridMouseService _gridMouseService = null!;
        private GridBuildService _gridBuildService = null!;
        private GridDemolishService _gridDemolishService = null!;
        private GridInputHandler _gridInputHandler = null!;
        ...
        private void Awake()
        {
            ...
            _gridBuildService = new GridBuildService(
                ...
                _gridMouseService);
            _gridDemolishService = new GridDemolishService(
                _grid,
                CellBuildingManager,
                _dynamicRoadBuildingManager,
                _forestSpreadManager,
            ...
            mapFloor!.position = new UniVector3(firstGridObjectsPosition.X, -0.1f, firstGridObjectsPosition.Y);
        ...
        {
            _gridInputHandler.Bind(GameInput.Instance);
        }

        private void OnDisable()
        {
            _gridInputHandler.Unbind(GameInput.Instance);
        }
