...
{
    public SemiTruck(Grid<ModelGridObject> grid, Resource resource, float speed = 4, int maintenanceCost = 50, int purchaseCost = 500, int maxCarryCapacity = 25,int resourceAmount = 0, Route? route = null, float maintenanceRemainingTime = 0, float? moveRemainingTime = null) 
