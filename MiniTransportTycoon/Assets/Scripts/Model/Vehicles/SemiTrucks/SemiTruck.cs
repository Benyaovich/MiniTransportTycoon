...
{
    public SemiTruck(Grid<ModelGridObject> grid, Resource resource, float speed = 1, int maintenanceCost = 50, int price = 500, int maxCarryCapacity = 25,int resourceAmount = 0, Route? route = null, float maintenanceRemainingTime = 100, float? moveRemainingTime = null) 
